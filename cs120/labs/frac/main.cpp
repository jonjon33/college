...
All methods function properly, and the fractions automatically
reduce.  I had to add one line to the main function to cause
the result of addition to reduce as well.
